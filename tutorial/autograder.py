...
def loadModuleString(moduleSource):
    ...
    #    ValueError: import_module arg#2 should be a file or None
    #
    #f = StringIO(moduleCodeDict[k])
    #tmp = importlib.import_module(k, f, k, (".py", "r", importlib.PY_SOURCE))
...
if __name__ == '__main__':
    ...
    print(os.path.join(options.codeRoot, cp))
